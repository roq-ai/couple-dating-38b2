...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'complaint.create': {
    roles: ['app-administrator', 'customer-support'],
    key: 'new-complaint',
    tenantPath: ['company', 'user', 'complaint'],
    userPath: [],
  },
  'campaign.update': {
    roles: ['business-owner', 'marketing-manager'],
    key: 'campaign-update',
    tenantPath: ['company', 'user', 'campaign'],
    userPath: [],
  },
  'profile.delete': {
    roles: ['app-administrator'],
    key: 'profile-deletion',
...
const tenantRoles: string[] = ['business-owner', 'app-administrator', 'customer-support', 'marketing-manager'];
