...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Couple Dating`}</title>

        <meta
          name="description"
          content="Discover new relationships with Couple Dating - the innovative matchmaking and social networking app that offers diverse connection options for every preference and dynamic. Find meaningful connections, whether for romance, friendship, or networking, in a safe and inclusive space."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover new relationships with Couple Dating - the innovative matchmaking and social networking app that offers diverse connection options for every preference and dynamic. Find meaningful connections, whether for romance, friendship, or networking, in a safe and inclusive space.`}
            </Text>
            <Box
