...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'app-administrator', 'customer-support', 'marketing-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Campaigns', path: '/campaigns', entity: 'campaign', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    {
      name: 'Complaints',
      path: '/complaints',
      entity: 'complaint',
